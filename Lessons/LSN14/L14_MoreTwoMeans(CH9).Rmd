...
Calculating the p-value: \sol{\texttt{1 - pf(fstat, I-1, N-1)}}
...
\sol{Atkins vs. Zone because they do not include zero.  The Atkins diet is associated with a significantly greater decrease in BMI than the Zone diet. }
