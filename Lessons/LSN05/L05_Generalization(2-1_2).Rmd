...
2.  Which represents the *sample's* average for a quantitative variable?
    \sol{$\bar{x}$. We can calculate it with 'mean(x)' in R.}
...
6.  What does the last remaining symbol represent?
    \sol{$\mu$ is the population's average for a quantitative variable.}

## Definitions

-   **generalization**

\sol{How broadly the conclusions apply. It is to which, if any, larger group of individuals our results may apply to outside of the assessed sample.}
\vfill

-   **population**

\sol{Indicated by $N$. The population is the entire set of observational units of a certain group}
\vfill

-   **sample**

\sol{Indicated by $n$. Some smaller subset of a larger population}
\vfill
...
\sol{No. Larger sample size will not fix a biased sampling method.} \vfill
...
\sol{$SD(\pi) = \sqrt{\pi (1-\pi) / n}; \qquad SD(\bar{x}) = \frac{\sigma}{\sqrt{n}}$}
\vfill 
...
\sol{Everybody assigned to the Battalion}
\vfill 

Q5) What is the sample?

\sol{The 20 Soldiers you asked, who belong as a part of the Battalion}
\vfill 

Q6) What kind of sample did you just take?

\sol{This is known as a convenience sample.}
\vfill 


Q7) Is this type of sample biased or unbiased? 

\sol{This type of sample is biased.}
\vfill 
...
\sol{No – increasing n does not fix a biased sampling method}
\vfill 
...
\sol{No. it’s possible some sick call were released for the day}
\vfill 
...
\sol{Collect a few more random samples of 20 observations, and average the proportions.}
\vfill 
...
The variables here are Length of the Word (quantitative) and contains *e* (categorical).}
...
**11.** Do you think that closing our eyes and pointing blindly at a page with a pencil 10 times would result in
...
**12.** Do you think that selecting 20 words instead of 10 would remove any bias in the previous two methods?
Explain.
...
**14.** In R, use \color{blue} sample(1:268, 10) \color{black} to randomly sample 10 numbers between 1 and 268 (without replacement). 
...
**15.**	Calculate the average length of the 10 words in your new sample and write it below.
...
Identify each of the following by describing it or stating its value (where possible).

**a.)** Population of interest

\sol{All the customers of the store}
\vfill

**b.)** Sample

\sol{The 100 people asked to fill out the survey}
\vfill

**c.)** Parameter of interest

\sol{The proportion of all customers that visit the store because of the
sale on coats}
\vfill

**d.)** Statistic

\sol{The proportion of the sample that said they visited the store because
of the sale on coats (0.40)}
\vfill

**20.** Explain whether or not you believe the sample is representative of the population of interest and why.

\sol{It may not be representative because it was not a random sample.}
\vfill
...
\sol{All full-time students at the school}
\vfill

**b.)** Sample

\sol{The 150 students in the sample}
\vfill

**c.)** Parameter of interest

\sol{The average daily study time for all full-time students at the school}
\vfill

**d.)** Statistic

\sol{The average daily study time for the students in the sample (2.23 hours)}
\vfill

**21.** Explain whether or not you believe the sample is representative of the population of interest and why.

\sol{Because it is a random sample it should be representative of the population.}
\vfill
